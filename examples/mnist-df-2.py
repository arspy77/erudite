...
if FLAGS.job_name == "ps":
    ...
    with tf.device(
        ...
        cross_entropy_ascent = tf.nn.softmax_cross_entropy_with_logits(dropout_logits_ascent, y__ascent)
        ...
        cross_entropy_descent = tf.nn.softmax_cross_entropy_with_logits(dropout_logits_descent, y__descent)
