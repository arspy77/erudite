...
if FLAGS.job_name == "ps":
    ...
    with tf.device(
        ...
        assign_b4_ascent = b1_ascent.assign(b4)
        assign_b5_ascent = b2_ascent.assign(b5)
        assign_b6_ascent = b3_ascent.assign(b6)
        ...
        assign_b4_descent = b1_descent.assign(b4)
        assign_b5_descent = b2_descent.assign(b5)
        assign_b6_descent = b3_descent.assign(b6)
